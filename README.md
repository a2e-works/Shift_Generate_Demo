...
> 既存のExcelシフトを変えずに、教育・属人化・将来リスクを可視化し、
> 希望休を叶えることと教育計画を両立させながら、管理者がより良い判断をできるよう
> 支援するシステムです(架空データによるデモ/V1)。
...
教育・属人化・将来リスクを可視化し、**希望休を叶えることと教育計画を両立させながら**、
管理者や決裁者がより良い判断をできるよう支援する
**シフト改善支援システム**です。
